...
@InputType()
class InternCreateInput {
  @ApiProperty({
    required: false,
    type: () => ApplicationCreateNestedManyWithoutInternsInput,
  })
  @ValidateNested()
  @Type(() => ApplicationCreateNestedManyWithoutInternsInput)
  @IsOptional()
  @Field(() => ApplicationCreateNestedManyWithoutInternsInput, {
    nullable: true,
  })
...
export { InternCreateInput as InternCreateInput };
