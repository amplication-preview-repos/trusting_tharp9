...
@InputType()
class InternUpdateInput {
  @ApiProperty({
    required: false,
    type: () => ApplicationUpdateManyWithoutInternsInput,
  })
  @ValidateNested()
  @Type(() => ApplicationUpdateManyWithoutInternsInput)
  @IsOptional()
  @Field(() => ApplicationUpdateManyWithoutInternsInput, {
    nullable: true,
  })
...
export { InternUpdateInput as InternUpdateInput };
